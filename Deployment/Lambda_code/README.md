...
The Lambda function implements the core rate limiting logic and give the simple frontnd ui.

### Key Responsibilities

* Identify the client making the request
* Retrieve request count from DynamoDB
...
2. Fetch the current request count from DynamoDB.
3. Increment the counter.
4. If the request exceeds the limit, return a **429 response**.
5. Otherwise store the updated count in DynamoDB.
6. TTL automatically resets the counter after the time window.
